...
const brokerNurtureTexts: string[] = [
  'Hey {brokerFirst} — wanted to say thanks again for the {firm} intro. If you have any other tenants evaluating space, I can turn around renderings in 48 hours. Always happy to help your deals close faster.',
  ...
  'Hey {brokerFirst} — just wrapped a project similar to one of your deals. Came out great. If you have anything in the pipeline where visuals could help, let me know.',
