...
const sequences: Sequence[] = [
  {
    ...
    steps: [
      ...
      { day: 7, channel: 'email', auto: false, message: 'Send a value-add email: market insight, a relevant article, or a completed project they\'d find interesting.' },
      { day: 14, channel: 'text', auto: false, message: 'Casual check-in text. Ask what they\'re hearing in the market or reference a specific deal type.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { day: 5, channel: 'text', auto: false, message: 'Follow-up text: "Hey [Name] — sent you a note earlier this week. Would love to be a resource for your deals at [Firm]."' },
      ...
      { day: 21, channel: 'email', auto: false, message: 'Final touch: "Last note from me — just wanted to make sure you know I\'m here if your tenants ever need space visualization. Happy to help anytime."' },
    ],
  },
  {
    ...
    steps: [
      ...
      { day: 1, channel: 'text', auto: false, message: 'If no answer on call, send a text: "Hey [Name] — [Broker] connected us re: [opportunity]. Would love to chat briefly."' },
      ...
      { day: 5, channel: 'text', auto: false, message: 'Quick text check-in: "Any updates on the space search? Happy to put together a quick visual of the top options."' },
      ...
      { day: 15, channel: 'text', auto: false, message: 'Casual follow-up: "Still happy to help if the timing works out. Let me know!"' },
      { day: 18, channel: 'email', auto: false, message: 'Graceful close: "Wanted to make sure this didn\'t slip through — happy to help whenever the timing is right."' },
    ],
  },
];
        ...
        <div key={sIdx} className="bg-white rounded-lg border border-[#e8e8e0]">
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-500">{seq.steps.length} steps over {seq.totalDays} days</p>
            </div>
            <svg
              className={`w-5 h-5 text-gray-400 transition-transform ${expandedSeq === sIdx ? 'rotate-180' : ''}`}
